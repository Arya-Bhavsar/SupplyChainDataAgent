from sqlalchemy import ForeignKey, create_engine, String, Integer, Numeric, Boolean, Float, Date
...
class Sale(Base):
    ...
    postal_code: Mapped[str] = mapped_column(String, ForeignKey("zip_codes.zip"))
