...
### RESPONSE FORMAT
- First, final response in natural language. Read-only queries: Present data in Markdown tables if multiple records.
- Then, outline the steps taken to answer the non-basic requests.
